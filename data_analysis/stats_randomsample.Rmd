...
pooleddf <- p[ , grep1("917x", names( p  ) ) ]
print(pooleddf)
names(pooleddf)

pooleddf_full <- pooleddf[ , grep1("full", names( pooleddf  ) ) ]
...
forDist_samp_917<-data.frame(cbind(InvDistanceData, pooleddf_full) 
