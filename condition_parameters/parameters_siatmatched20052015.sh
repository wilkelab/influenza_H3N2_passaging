...
#SIAT1 cell culture
#Cell culture
#Pooled group of all passage types including unsortable sequences
#CDM 10/30/15
...
python $BASEDIR/scripts/randomdraw.py $SOURCE/complete_unpassaged_all_20052015.fasta $SOURCE/complete_nonsiat_all_20052015.fasta $SOURCE/complete_pooled_all_20052015.fasta $SOURCE/complete_cell_all_20052015.fasta $SOURCE/complete_siat_all_20052015.fasta
